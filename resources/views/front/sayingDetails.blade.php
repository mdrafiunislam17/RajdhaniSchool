...
@section('title', 'Saying & Member Details')
...
@section('content')
    ...
    <main>
        ...
        <div class="relative z-10 mx-[19.71%]">
            <h1 class="font-semibold text-[clamp(35px,6vw,56px)] text-white">Saying & Member Details</h1>
            ...
            <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                <div class="flex md:flex-col items-center md:items-start gap-x-[30px] gap-y-[15px] border border-[#E5E5E5] rounded-[12px] p-[30px] xs:p-[20px] xxs:p-[15px]">
                    <div class="img shrink-0">
                        <img src="{{ asset('uploads/saying/' . $saying->image) }}" alt="team member image" class="w-[370px] xxs:max-w-full aspect-[74/75] rounded-[12px]">
                    </div>

                    <!-- txt -->
                    <div class="txt">
                        <h3 class="text-[30px] xxs:text-[25px] font-semibold mb-[6px]">{{$saying->name}}</h3>
                        <h6 class="text-edgray font-medium text-[16px]">{{$saying->position}}</h6>
                        <p class="font-normal text-[16px] text-edgray mt-[16px]">{!! $saying->description !!}</p>
...
{{--                            <li class="text-[16px]"><span class="font-medium text-edpurple">Experience:</span> {{$saying->experience}}</li>--}}
{{--                            <li class="text-[16px]"><span class="font-medium text-edpurple">Position:</span> {{$saying->position}}</li>--}}
{{--                            <li class="text-[16px]"> <span class="font-medium text-edpurple">Phone:</span> {{$saying->phone}}</li>--}}
{{--                        </ul>--}}
            ...
            <div class="mx-[19.71%] xxxl:mx-[14.71%] xxl:mx-[9.71%] xl:mx-[5.71%] md:mx-[12px]">
                ...
                <div class="ed-teachers-slider swiper">
                    <div class="swiper-wrapper">
                        <!-- single teacher -->
                        @foreach ($sayings as $item)


                           <div class="swiper-slide">
                            <div class="ed-teacher group">
                                <div class="ed-teacher__img rounded-[16px] overflow-hidden">
                                    <img src="{{ asset('uploads/saying/' . $item->image) }}" alt="Team Member Image" class="w-full aspect-[370/375] duration-[400ms] group-hover:scale-110">
                                </div>
