                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                   id="title" value="{{ old("title", $blog->title) }}" name="title" required autofocus>
                            @error('title')
                            ...
                            <div class="mt-2" id="imagePreview">
                                @if($blog->image)
                                    <div class="border p-2" style="max-width: 300px;">
                                        <img src="{{ asset('uploads/blog/'.$blog->image) }}" class="img-fluid" alt="Current Image">
                                        <div class="mt-2 text-center">Current Image</div>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control @error('posted_by') is-invalid @enderror"
                                   id="posted_by" value="{{ old("posted_by", $blog->posted_by) }}" name="posted_by" required>
                            @error('posted_by')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="datetime-local" class="form-control @error('posted_on') is-invalid @enderror"
                                   id="posted_on" value="{{ old('posted_on', Carbon::parse($blog->posted_on)->format('Y-m-d\TH:i')) }}"
                                   name="posted_on" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="short_detail" id="short_detail" class="form-control @error('short_detail') is-invalid @enderror"
                                      style="height: 120px" required>{{ old("short_detail", $blog->short_detail) }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="detail" id="detail" class="form-control @error('detail') is-invalid @enderror"
                                      required>{{ old("detail", $blog->detail) }}</textarea>
                            @error('detail')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
