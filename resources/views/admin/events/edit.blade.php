        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form action="{{ route("events.update", $event->id) }}" method="post"
                  ...
                  <div class="form-group row">
                    <label for="gallery" class="col-sm-3 col-form-label text-right font-weight-bold">Exist Gallery</label>
                    <div class="col-sm-6">
                                ...
                                @else
                                    @foreach($galleryImages as $i => $image)
                                        <tr id="gallery_item_{{ $i + 1 }}">
                                            ...
                                            <td>
                                                <img src="{{ asset("uploads/gallery/$image") }}" width="100" alt="{{ $image }}">
                                            </td>
                                            <td style="width: 50px">
                                                <button type="button"
                                                        onclick="document.getElementById('gallery_item_{{ $i + 1 }}').remove()"
