    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-primary text-white">
                <h1 class="h4 mb-0 font-weight-bold"><i class="fas fa-user-plus"></i> Create New Student</h1>
            </div>
            <div class="card-body">
                @if ($errors->any())
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group" id="groupField">
                                ...
                                <select name="student_group" id="student_group" class="form-control selectpicker">
                                    ...
                                    <option value="N/A" {{ old('student_group') == 'N/A' ? 'selected' : '' }}>N/A</option>
                                    <option value="science" {{ old('student_group') == 'science' ? 'selected' : '' }}>Science</option>
                                    <option value="arts" {{ old('student_group') == 'arts' ? 'selected' : '' }}>Arts</option>
                                    <option value="business" {{ old('student_group') == 'business' ? 'selected' : '' }}>Business Studies</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="student_phone" id="student_phone" class="form-control"
                                       value="{{ old('student_phone') }}" placeholder="+8801XXXXXXXXX">
                            </div>

                            <div class="form-group">
                                <label for="student_email">Student Email</label>
                                <input type="email" name="student_email" id="student_email" class="form-control"
                                       value="{{ old('student_email') }}" placeholder="student@example.com">
                            </div>

                            <div class="form-group">
                                <label for="religion">Religion</label>
                                <input type="text" name="religion" id="religion" class="form-control"
                                       value="{{ old('religion') }}" placeholder="Islam/Christianity/Hinduism etc.">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="present_address" id="present_address" class="form-control"
                                          rows="3" placeholder="Current living address">{{ old('present_address') }}</textarea>
                            </div>

                            <div class="form-group">
                                <label for="permanent_address">Permanent Address</label>
                                <textarea name="permanent_address" id="permanent_address" class="form-control"
                                          rows="3" placeholder="Permanent home address">{{ old('permanent_address') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="school_name" id="school_name" class="form-control"
                                       value="{{ old('school_name') }}" placeholder="School name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="guardian_phone" id="guardian_phone" class="form-control"
                                       value="{{ old('guardian_phone') }}" placeholder="+8801XXXXXXXXX">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="mt-2" id="studentPhotoPreview"></div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Max size: 2MB | Format: jpg, png, jpeg</small>
                                <div class="mt-2" id="guardianPhotoPreview"></div>
                            </div>
                        </div>
                    </div>
